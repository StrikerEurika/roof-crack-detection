...
class BaseService:
    ...
    def save_image_assets(self, base_name: str, visualization: object, binary_mask: object) -> tuple:
        """Saves visualization and binary mask to the historical results folder."""
